...
const Navbar: React.FC<NavProps> = ({ currPage }) => {
  ...
  return (
    <div className="fixed w-full bg-blue1 h-[4.5rem] p-4 flex items-center justify-between">
      <button onClick={() => (window.location.href = "/")} className={(currPage === "dashboard" ? "text-blue2 hover:text-black1 " : "text-white ") + "font-bold hhover:bg-pink1 ml-4  py-2 rounded-sm"}>
